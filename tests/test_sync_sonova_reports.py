...
class SyncSonovaReportsTest(unittest.TestCase):
    ...
    def test_discovers_contextual_sonova_links(self):
        config = {
            ...
            "allowed_pdf_paths": ["/sites/default/files/"],
            "index_pages": [{"kind": "financial-reports", "url": "https://www.sonova.com/en/financial-reports"}],
        }
        body = b"""
        <h3>Full-Year Results 2025/26</h3>
        <a href="/sites/default/files/2026-05/01_Sonova_AR_25-26_Full_Report_en.pdf"></a>
        <h3>Sustainability Report</h3>
        <a href="/sites/default/files/2026-05/10_Sonova_AR_25-26_Sustainability_en.pdf"></a>
        """
    ...
    def test_rejects_non_official_pdf_url(self):
        config = {"official_domain": "sonova.com", "allowed_pdf_paths": ["/sites/default/files/"]}
